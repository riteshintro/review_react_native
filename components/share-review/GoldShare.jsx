...
const GoldShare = ({params}) => {
 ...
 <Card style={{padding:10,backgroundColor:"white"}}>
    ...
    <View style={{backgroundColor:"#0A0D10",padding:20,borderRadius:16,borderColor:"#F0C777",borderWidth:1}}>
    <View style={{backgroundColor:"#1C1C1E",width:"100%", minHeight:300,borderRadius:20,padding:0,borderColor:"#F0C777",borderWidth:1}}>
        <View style={{marginTop:20,marginLeft:20,flexDirection:"row"}}>
        <View style={{borderWidth:1.5,borderColor:"gold", padding:1, borderRadius:50,marginRight:10}}><Avatar.Image size={24} source={{ uri: 'https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?t=st=1717577926~exp=1717581526~hmac=e3f265de67ff462c47ebed1421878e7f9497deb01e80f460974c5f9d115dd48b&w=996' }} /></View>
       
        <Text style={{color:"#F0C777",fontWeight:"bold"}}>Ritesh  maurya</Text></View>
      ...
      <Text style={{color:"#F0C777",minHeight:150,marginHorizontal:20,marginVertical:5}}>{params.text}</Text>
  ...
  <View style={{minHeight:60,borderBottomEndRadius:20,borderBottomStartRadius:20,borderTopColor:"#F0C777",borderTopWidth:1.5}}>
   <View style={{marginHorizontal:20,marginVertical:10,flexDirection:"row", justifyContent:"space-between"}}><View style={{flexDirection:"row",gap:5}}><Image style={{height:30,width:25}} source={require("../../assets/images/office.png")}/><View><Text style={{color:"white", fontWeight:"bold"}}>Ample Mortage</Text><Text style={{color:"white",fontSize:10,color:"#F0C777"}}>232 Reviews</Text></View></View>
   <View><Text style={{color:"#FDCB6A",fontWeight:"bold"}}>5/5.0</Text>
      <View style={{flexDirection:"row"}}><View style={{borderWidth:1,borderColor:"gold", padding:1, borderRadius:50}}><Avatar.Image size={15} source={{ uri: 'https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?t=st=1717577926~exp=1717581526~hmac=e3f265de67ff462c47ebed1421878e7f9497deb01e80f460974c5f9d115dd48b&w=996' }} /></View><View style={{borderWidth:1,borderColor:"gold", padding:1, borderRadius:50,marginLeft:2}}><Avatar.Image size={15} source={{ uri: 'https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?t=st=1717577926~exp=1717581526~hmac=e3f265de67ff462c47ebed1421878e7f9497deb01e80f460974c5f9d115dd48b&w=996' }} /></View></View>
   </View>
   </View> 
  </View>
    </View>
